...
class flagDay { // please forgive me for my sins
  ...
  is() {
    ...
    switch (this.month) {
      case "february":
        if ((this.day >= 2 && this.day <= 8) && this.weekDay === "sunday") { // kynttiläpäivä
          return true;
        }
        if ((this.day === 29)) {
          return true;
        ...
        break;
      case "march":
        if((this.day >=22 && this.day <= 28) && this.weekDay === "sunday") { //Marian ilmestymispäivä
          return true;
        }
      ...
      case "november":
        if ((this.day >= 7 && this.day <= 15) && this.weekDay === "sunday") {
          this.month === "may" ? console.log("Happy mothers day") : console.log("Happy fathers day");
          return true;
        };
