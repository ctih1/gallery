<script lang="ts">
	...
	function beginTest() {
		...
		xhr.addEventListener('progress', (e) => {
			...
			const now = new Date();
			speed =
				((e.loaded - lastAmount) / (now.getTime() / 1000 - lastEvent.getTime() / 1000) / 1000000) *
				8;
			speeds.push(speed);
...
<h1>speedtest</h1>
<p>
	Test your connection speed to this server! Mostly meant to measure my server's internet speed, as
	it's most likely the bottleneck.
</p>
<p>
